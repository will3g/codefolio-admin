...
export default class SecondarySubhome extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        const { secondarySubhome } = this.props;
        ...
        return (
            <Stack spacing={5} sx={{
                ...
                <Autocomplete
                    ...
                    value={secondarySubhome}
                    renderInput={(params) => (
                        <TextField {...params} label="Secondary subhomes" />
                    )}
                />
            </Stack>
        );
